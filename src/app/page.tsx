        ...
        <main className="relative min-h-screen">
          ...
          <div className="flex flex-col min-h-screen pt-20 sm:pt-24 pb-8">
            ...
            <div className="flex-1 flex flex-col justify-center px-4 sm:px-6 lg:px-8">
              ...
              {/* Main Headline - Optimized for sentence case */}
              <div className="text-center space-y-4 sm:space-y-6 mb-8 sm:mb-12">
                <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-[var(--text-primary)] leading-tight tracking-tight px-4 max-w-2xl sm:max-w-3xl md:max-w-4xl lg:max-w-5xl mx-auto">
                  Learn from YouTube videos instantly
                </h1>

                <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-[var(--text-secondary)] leading-relaxed max-w-lg sm:max-w-xl md:max-w-3xl lg:max-w-4xl mx-auto px-4">
                  Complete knowledge, not summaries. Same as watching, 10x faster.
                </p>
              </div>
