...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  return (
    <div style={{ display: 'flex', minHeight: '100vh', width: '100vw', background: '#111112' }}>
      ...
      <aside style={{ width: 320, minWidth: 320, maxWidth: 320, background: '#1a1a1a', height: '100vh', overflowY: 'auto', borderRight: '1px solid #232323', boxShadow: '2px 0 8px 0 rgba(0,0,0,0.08)', zIndex: 10 }} />
