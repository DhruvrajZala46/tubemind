...
const bypassAuthMiddleware = (req: NextRequest) => {
  ...
  const csp = "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' blob: https://js.clerk.dev https://cdn.jsdelivr.net https://clerk.tubemind.live https://*.clerk.dev https://*.clerk.com https://challenges.cloudflare.com https://*.cloudflare.com https://www.google.com https://www.gstatic.com; worker-src 'self' blob:; style-src 'self' 'unsafe-inline' https://js.clerk.dev https://cdn.jsdelivr.net https://clerk.tubemind.live https://*.clerk.dev https://*.clerk.com https://challenges.cloudflare.com https://*.cloudflare.com; style-src-elem 'self' 'unsafe-inline' https://js.clerk.dev https://cdn.jsdelivr.net https://clerk.tubemind.live https://*.clerk.dev https://*.clerk.com https://challenges.cloudflare.com https://*.cloudflare.com; img-src 'self' data: https: https://challenges.cloudflare.com https://*.cloudflare.com; connect-src 'self' https: https://challenges.cloudflare.com https://*.cloudflare.com; font-src 'self' https: data:; frame-src 'self' https://challenges.cloudflare.com https://*.cloudflare.com;";
